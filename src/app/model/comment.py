...
from src.app.model.base import BaseModel, T_create_time
...
class Comment(BaseModel):
    ...
    platform: Mapped[str] = mapped_column(String(20), default=None, comment="客户端")
    device: Mapped[str] = mapped_column(String(20), default=None, comment="设备")
